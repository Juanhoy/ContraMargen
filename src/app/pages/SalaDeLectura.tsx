...
export default function SalaDeLectura() {
  const writings = [
    ...
    },
    {
      ...
      type: 'Poesía',
      readTime: '3 min',
      excerpt: 'En el borde de este polvo hay instaladas cuatromildoscientas maravillas de agua esperando el asombro de los transeúntes para surcar el cielo. Rodeada de ojos, la insomne, respira el aire que le queda.',
    ...
    },
    {
      ...
      type: 'Poesía',
      readTime: '4 min',
      excerpt: '¿Dónde estás, Dios? ¿Por qué no me apuñalas tú mi hígado de cerdo? Oh, Jehová, tengo miedo. Tú que eres el Dios de dioses, príncipe de príncipes, rey sabio, justo y verdadero...',
  ...
  const featuredPoem = {
    ...
    lines: [
      ...
      'Suspiro...',
      '',
      'Entre abro los ojos por instantes y le regalo besos a mis hombros, me acaricio con delicadeza el abdomen, abrazo mis piernas que esta vez se abren para mí.',
